...
func BaixingShangwuExtractorPc(html string) (models.HtmlExtractorResult, error) {
...
func BaixingShangwuExtractorMobile(html string) (models.HtmlExtractorResult, error) {
	res := models.HtmlExtractorResult{}
	dom, err := goquery.NewDocumentFromReader(strings.NewReader(html))
	if err != nil {
		return res, err
